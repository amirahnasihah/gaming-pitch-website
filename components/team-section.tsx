...
const PlayerCard = ({ player }: { player: PlayerProps }) => {
  ...
  return (
    <ThreeDCard
      ...
      rotationIntensity={5}
    >
      <Card className="bg-black/40 border-purple-500/20 overflow-hidden relative group h-full backdrop-blur-sm">
              ...
              <div className="flex space-x-2">
                {player.instagram && (
                  <a
                    ...
                    className="bg-black/50 p-2 rounded-full hover:bg-purple-600 transition-colors"
                  >
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <Tabs defaultValue="players" className="w-full">
          <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 mb-12 bg-black/40 backdrop-blur-sm">
